...
if("TRUE" STREQUAL "TRUE")
  set(rf2o_laser_odometry_SOURCE_PREFIX /home/kinetic/xrobot_ws/src/rf2o_laser_odometry)
  set(rf2o_laser_odometry_DEVEL_PREFIX /home/kinetic/xrobot_ws/devel)
  ...
  set(rf2o_laser_odometry_INSTALL_PREFIX /home/kinetic/xrobot_ws/install)
...
if(NOT "/home/kinetic/xrobot_ws/src/rf2o_laser_odometry/include " STREQUAL " ")
  set(rf2o_laser_odometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/kinetic/xrobot_ws/src/rf2o_laser_odometry/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rf2o_laser_odometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kinetic/xrobot_ws/src/rf2o_laser_odometry/${idir}'.  Ask the maintainer 'Javier G. Monroy <jgmonroy@uma.es>' to fix it.")
    endif()
