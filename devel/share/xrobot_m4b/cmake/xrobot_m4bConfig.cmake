...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xrobot_m4b' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kinetic/xrobot_ws/src/xrobot_m4b/${idir}'.  Ask the maintainer 'XCore <2320935@qq.com>' to fix it.")
    endif()
