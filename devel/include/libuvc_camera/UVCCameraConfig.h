...
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<std::string>("video_mode", "str", 3, "Format of video stream from camera.", "{'enum_description': 'Video stream format', 'enum': [{'srcline': 36, 'description': 'Use any uncompressed format', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'uncompressed', 'ctype': 'std::string', 'type': 'str', 'name': 'uncompressed'}, {'srcline': 37, 'description': 'User any compressed format', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'compressed', 'ctype': 'std::string', 'type': 'str', 'name': 'compressed'}, {'srcline': 38, 'description': 'YUYV', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'yuyv', 'ctype': 'std::string', 'type': 'str', 'name': 'yuyv'}, {'srcline': 39, 'description': 'UYVY', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'uyvy', 'ctype': 'std::string', 'type': 'str', 'name': 'uyvy'}, {'srcline': 40, 'description': 'RGB', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'rgb', 'ctype': 'std::string', 'type': 'str', 'name': 'rgb'}, {'srcline': 41, 'description': 'BGR', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'bgr', 'ctype': 'std::string', 'type': 'str', 'name': 'bgr'}, {'srcline': 42, 'description': 'MJPEG', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'mjpeg', 'ctype': 'std::string', 'type': 'str', 'name': 'mjpeg'}, {'srcline': 43, 'description': 'gray8', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'gray8', 'ctype': 'std::string', 'type': 'str', 'name': 'gray8'}]}", &UVCCameraConfig::video_mode)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<std::string>("timestamp_method", "str", 3, "Method for determining the timestamp.", "{'enum_description': 'Methods for determining the timestamp', 'enum': [{'srcline': 53, 'description': 'Time of publication', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'pub', 'ctype': 'std::string', 'type': 'str', 'name': 'PubTime'}, {'srcline': 54, 'description': 'Time when raw frame capture began', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'start', 'ctype': 'std::string', 'type': 'str', 'name': 'FrameStartTime'}, {'srcline': 55, 'description': 'Time when raw frame capture ended', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'stop', 'ctype': 'std::string', 'type': 'str', 'name': 'FrameStopTime'}, {'srcline': 56, 'description': 'Time when camera-to-host transfer completed', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'hostrcpt', 'ctype': 'std::string', 'type': 'str', 'name': 'HostReceiptTime'}]}", &UVCCameraConfig::timestamp_method)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<std::string>("timestamp_method", "str", 3, "Method for determining the timestamp.", "{'enum_description': 'Methods for determining the timestamp', 'enum': [{'srcline': 53, 'description': 'Time of publication', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'pub', 'ctype': 'std::string', 'type': 'str', 'name': 'PubTime'}, {'srcline': 54, 'description': 'Time when raw frame capture began', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'start', 'ctype': 'std::string', 'type': 'str', 'name': 'FrameStartTime'}, {'srcline': 55, 'description': 'Time when raw frame capture ended', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'stop', 'ctype': 'std::string', 'type': 'str', 'name': 'FrameStopTime'}, {'srcline': 56, 'description': 'Time when camera-to-host transfer completed', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const char * const', 'value': 'hostrcpt', 'ctype': 'std::string', 'type': 'str', 'name': 'HostReceiptTime'}]}", &UVCCameraConfig::timestamp_method)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.frame_id = "";
...
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("scanning_mode", "int", 0, "Scanning mode.", "{'enum_description': 'Scanning modes', 'enum': [{'srcline': 72, 'description': '', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Interlaced'}, {'srcline': 73, 'description': '', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Progressive'}]}", &UVCCameraConfig::scanning_mode)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("scanning_mode", "int", 0, "Scanning mode.", "{'enum_description': 'Scanning modes', 'enum': [{'srcline': 72, 'description': '', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Interlaced'}, {'srcline': 73, 'description': '', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Progressive'}]}", &UVCCameraConfig::scanning_mode)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("auto_exposure", "int", 0, "Auto exposure mode.", "{'enum_description': 'Auto-exposure modes', 'enum': [{'srcline': 80, 'description': 'Manual exposure, manual iris', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Manual'}, {'srcline': 81, 'description': 'Auto exposure, auto iris', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Auto'}, {'srcline': 82, 'description': 'manual exposure, auto iris', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Shutter_Priority'}, {'srcline': 83, 'description': 'auto exposure, manual iris', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Aperture_Priority'}]}", &UVCCameraConfig::auto_exposure)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("auto_exposure", "int", 0, "Auto exposure mode.", "{'enum_description': 'Auto-exposure modes', 'enum': [{'srcline': 80, 'description': 'Manual exposure, manual iris', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Manual'}, {'srcline': 81, 'description': 'Auto exposure, auto iris', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Auto'}, {'srcline': 82, 'description': 'manual exposure, auto iris', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Shutter_Priority'}, {'srcline': 83, 'description': 'auto exposure, manual iris', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Aperture_Priority'}]}", &UVCCameraConfig::auto_exposure)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("power_line_frequency", "int", 0, "Power line frequency anti-flicker processing.", "{'enum_description': 'Power line frequency modes', 'enum': [{'srcline': 146, 'description': 'Disabled', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Disabled'}, {'srcline': 147, 'description': '50 Hz', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Freq_50'}, {'srcline': 148, 'description': '60 Hz', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Freq_60'}]}", &UVCCameraConfig::power_line_frequency)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("power_line_frequency", "int", 0, "Power line frequency anti-flicker processing.", "{'enum_description': 'Power line frequency modes', 'enum': [{'srcline': 146, 'description': 'Disabled', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Disabled'}, {'srcline': 147, 'description': '50 Hz', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Freq_50'}, {'srcline': 148, 'description': '60 Hz', 'srcfile': '/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Freq_60'}]}", &UVCCameraConfig::power_line_frequency)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.auto_hue = 0;
...
//#line 36 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_uncompressed = "uncompressed";
//#line 37 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_compressed = "compressed";
//#line 38 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_yuyv = "yuyv";
//#line 39 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_uyvy = "uyvy";
//#line 40 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_rgb = "rgb";
//#line 41 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_bgr = "bgr";
//#line 42 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_mjpeg = "mjpeg";
//#line 43 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_gray8 = "gray8";
//#line 53 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_PubTime = "pub";
//#line 54 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_FrameStartTime = "start";
//#line 55 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_FrameStopTime = "stop";
//#line 56 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_HostReceiptTime = "hostrcpt";
//#line 72 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Interlaced = 0;
//#line 73 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Progressive = 1;
//#line 80 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Manual = 0;
//#line 81 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Auto = 1;
//#line 82 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Shutter_Priority = 2;
//#line 83 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Aperture_Priority = 3;
//#line 146 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Disabled = 0;
//#line 147 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Freq_50 = 1;
//#line 148 "/home/kinetic/xrobot_ws/src/libuvc_ros/libuvc_camera/cfg/UVCCamera.cfg"
