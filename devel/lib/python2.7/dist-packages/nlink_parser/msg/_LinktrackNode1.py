...
"""autogenerated by genpy from nlink_parser/LinktrackNode1.msg. Do not edit."""
import sys
...
class LinktrackNode1(genpy.Message):
  _md5sum = "d132fffb83ae82e5909718b6a85eaccc"
  _type = "nlink_parser/LinktrackNode1"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """uint8 role
uint8 id
float32[3] pos_3d
"""
  __slots__ = ['role','id','pos_3d']
  _slot_types = ['uint8','uint8','float32[3]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LinktrackNode1, self).__init__(*args, **kwds)
