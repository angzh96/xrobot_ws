...
"""autogenerated by genpy from nlink_parser/LinktrackAoaNodeframe0.msg. Do not edit."""
import sys
...
class LinktrackAoaNodeframe0(genpy.Message):
  _md5sum = "0f131ffd1a11760ff33ff513bfedb13a"
  _type = "nlink_parser/LinktrackAoaNodeframe0"
...
"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','nlink_parser/LinktrackAoaNode0[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LinktrackAoaNodeframe0, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.nodes:
        _x = val1
        buff.write(_get_struct_2B4f().pack(_x.role, _x.id, _x.dis, _x.angle, _x.fp_rssi, _x.rx_rssi))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = nlink_parser.msg.LinktrackAoaNode0()
        _x = val1
        start = end
        end += 18
        (_x.role, _x.id, _x.dis, _x.angle, _x.fp_rssi, _x.rx_rssi,) = _get_struct_2B4f().unpack(str[start:end])
