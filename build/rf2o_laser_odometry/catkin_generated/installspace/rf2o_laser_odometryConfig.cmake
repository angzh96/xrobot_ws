...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rf2o_laser_odometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kinetic/xrobot_ws/install/${idir}'.  Ask the maintainer 'Javier G. Monroy <jgmonroy@uma.es>' to fix it.")
    endif()
