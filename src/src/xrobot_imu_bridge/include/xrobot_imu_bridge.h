...
#ifndef _XROBOT_IMU_BRIDGE_H_
#define _XROBOT_IMU_BRIDGE_H_
...
class xrobotImuBridge
{
  ...
  public:
    xrobotImuBridge(ros::NodeHandle nh, ros::NodeHandle pnh);
    virtual ~xrobotImuBridge(void){};
};

#endif  // _XROBOT_IMU_BRIDGE_H_
